...
namespace Train
{
    ...
    public class FakeDataFunction
    {
        public static void InjectTestData(ITrainPersistant trainPersistant)
        {
            ...
            StationInfo taruku402_taipei = new StationInfo(Taipei.StationName, taruku402_trunkLine, new TimeOnly(6, 11), new TimeOnly(6, 13));
            StationInfo taruku402_banqiao = new StationInfo(Banqiao.StationName, taruku402_trunkLine, new TimeOnly(6, 1), new TimeOnly(6, 3));
            StationInfo taruku402_hualian = new StationInfo(Hualian.StationName, taruku402_trunkLine, new TimeOnly(8, 19), new TimeOnly(8, 22));
            ...
            StationInfo zichiang272_taipei = new StationInfo(Taipei.StationName, zichiang272_trunkLine, new TimeOnly(7, 21), new TimeOnly(7, 24));
            StationInfo zichiang272_banqiao = new StationInfo(Banqiao.StationName, zichiang272_trunkLine, new TimeOnly(7, 08), new TimeOnly(7, 10));
            StationInfo zichiang272_Hualian = new StationInfo(Hualian.StationName, taruku402_trunkLine, new TimeOnly(10, 42), new TimeOnly(10, 42));
            ...
            StationInfo zichiang408_banqiao = new StationInfo(Banqiao.StationName, zichiang408_trunkLine, new TimeOnly(7, 13), new TimeOnly(7, 16));
            StationInfo zichiang408_taipei = new StationInfo(Taipei.StationName, zichiang408_trunkLine, new TimeOnly(7, 25), new TimeOnly(7, 30));
            StationInfo zichiang408_Hualian = new StationInfo(Hualian.StationName, zichiang408_trunkLine, new TimeOnly(9, 40), new TimeOnly(9, 43));
            ...
            StationInfo 莒光511_taipei = new StationInfo(Taipei.StationName, 莒光511_trunkLine, new TimeOnly(9, 13), new TimeOnly(9, 17));
            StationInfo 莒光511_banqiao = new StationInfo(Banqiao.StationName, 莒光511_trunkLine, new TimeOnly(9, 25), new TimeOnly(9, 27));
            StationInfo 莒光511_Taoyuan = new StationInfo(Taoyuan.StationName, 莒光511_trunkLine, new TimeOnly(9, 53), new TimeOnly(9, 54));
            ...
            StationInfo 區間2193_taipei = new StationInfo(Taipei.StationName, 區間2193_trunkLine, new TimeOnly(12, 0), new TimeOnly(12, 02));
            StationInfo 區間2193_banqiao = new StationInfo(Banqiao.StationName, 區間2193_trunkLine, new TimeOnly(12, 11), new TimeOnly(12, 12));
            StationInfo 區間2193_Taoyuan = new StationInfo(Taoyuan.StationName, 區間2193_trunkLine, new TimeOnly(12, 39), new TimeOnly(12, 41));
            StationInfo 區間2193_Taichung = new StationInfo(Taichung.StationName, 區間2193_trunkLine, new TimeOnly(15, 35), new TimeOnly(15, 36));
            ...
            StationInfo 普悠273_hualian = new StationInfo(Hualian.StationName, 普悠273_trunkLine, new TimeOnly(13, 26), new TimeOnly(13, 26));
            StationInfo 普悠273_taipei = new StationInfo(Taipei.StationName, 普悠273_trunkLine, new TimeOnly(15, 41), new TimeOnly(15, 45));
            StationInfo 普悠273_banqiao = new StationInfo(Banqiao.StationName, 普悠273_trunkLine, new TimeOnly(15, 52), new TimeOnly(15, 53));
            StationInfo 普悠273_Taichung = new StationInfo(Taichung.StationName, 普悠273_trunkLine, new TimeOnly(17, 23), new TimeOnly(17, 25));
